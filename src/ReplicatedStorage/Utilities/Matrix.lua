...
-- Det for 2x2 and 3x3 matrices ONLY!
function matrix:Det():number
	...
	elseif #self == 9 then -- 3x3
		...
		local C = self:Cofactors() -- matrice des cofacteurs, com(A)
		
		for i = 1,3 do
			det+=C:Get(2,i)*self:Get(2,i)
		end
	end
